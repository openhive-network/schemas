...
- [schemas definitions for wallet bridge API](package/schemas/wallet_bridge_api/response_schemas.py)
...
TestTools provides support for schemas, to validate all responses automatically. Everytime when you call a method,
...
<th colspan="3" style="font-weight:normal">Asset its a representation of the Hive currency. In Hive we have three different types of assets, so
...
**Price** - Similar to 'currency pair' used to determine value of currencies.
For example:
