...
# [op]get_transaction 'operations' poprawić po aktualizacji
# [op]get_ops_in_block 'pole 'op' do aktualizacji
# [BUG/ in repair]get_witness TODO Schema is not complete, finish after fixing the bug.
"""
...
get_accounts = Array(__my_account)

list_accounts = Array(Str())

list_my_accounts = Array(__my_account)
...
get_dynamic_global_properties = Map({
    ...
    'sps_fund_percent': Int(),
    'sps_interval_ledger': AssetHbd(),
