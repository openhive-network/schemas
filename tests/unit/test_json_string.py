...
class ApplicationTestOperation(ApplicationOperation):
...
def test_json_string_with_existing_custom_type() -> None:
    # ARRANGE
    application_operation = SomeCustomType()

    # ACT
    # ASSERT
    JsonString(application_operation)


def test_json_string_with_new_custom_type() -> None:
    # ACT
    # ASSERT
    JsonString(SomeCustomType())


def test_negative_json_string_with_existing_custom_type() -> None:
    # ARRANGE
    application_operation = InvalidCustomType()

    # ACT
    # ASSERT
    with pytest.raises(ValueError, match=JSON_STRING_INVALID_TYPE_PATTERN):
        JsonString.validate(application_operation)


def test_negative_json_string_with_new_custom_type() -> None:
    # ACT
    # ASSERT
    with pytest.raises(ValueError, match=JSON_STRING_INVALID_TYPE_PATTERN):
...
def test_negative_application_operation_validate_from_stringincorrect() -> None:
    # ARRANGE
