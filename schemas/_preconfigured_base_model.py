...
import json
import typing
from typing import AbstractSet, Any, Dict, Iterable, Literal, Mapping, Optional, TypeVar, Union
...
class PreconfiguredBaseModel(msgspec.Struct):
    ...
    def json(  # noqa: PLR0913, A003
        ...
        *,
        ...
        return json.dumps(msgspec.to_builtins(obj=self, enc_hook=enc_hook_base, str_keys=str_keys, builtin_types=builtin_types, order=order))
    ...
    def dict(  # noqa: PLR0913, A003
        ...
        *,
        ...
        return msgspec.to_builtins(obj=self, enc_hook=enc_hook_base, str_keys=str_keys, builtin_types=builtin_types, order=order)
