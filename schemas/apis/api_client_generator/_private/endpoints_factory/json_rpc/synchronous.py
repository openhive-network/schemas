...
def create_endpoint(  # NOQA: PLR0913
    ...
    *,
    ...
    """
    Create a synchronous JSON-RPC endpoint method.

    Args:
        name(str): The name of the endpoint.
        params(Dataclass | None): A dictionary of parameter names and their types.
    ...
    Notice:
        ...
        that will is compatible with `fields` method from `dataclasses` module).

    Returns:
        ast.FunctionDef: The AST representation of the endpoint method.
