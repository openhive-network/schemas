...
def generate_api_client(  # NOQA: PLR0913
    ...
    *,
    ...
    Raises:
        MoreThanOneApiPassedToSingleGeneratorError: If more than one or none API description is provided. If you want to generate a client for multiple APIs,
        use `generate_api_collection` instead or pass your api descriptions one by one.
    ...
    Example:
        ...
        generate_dapi_client(my_api_description, AbstractAsyncApi)
    """
    check_whether_was_ran_as_script()

    if len(api_description.keys()) != 1:
        raise InvalidApiDescriptionAmountError
