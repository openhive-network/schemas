...
# from schemas.fields.assets.hbd import AssetHbd, AssetHbd
# from schemas.fields.assets.hive import AssetHive, AssetHiveT
...
class GetDynamicGlobalPropertiesOrig(PreconfiguredBaseModel, kw_only=True):
    ...
    pending_rewarded_vesting_shares: AssetVest
    ...
    total_vesting_shares: AssetVest
