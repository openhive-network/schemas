...
from schemas.account_by_key_api import response_schemas as account_by_key_api  # noqa: F401
from schemas.account_history_api import response_schemas as account_history_api  # noqa: F401
...
from schemas.market_history_api import response_schemas as market_history_api  # noqa: F401
from schemas.network_broadcast_api import response_schemas as network_broadcast_api  # noqa: F401
...
from schemas.transaction_status_api import response_schemas as transaction_status_api  # noqa: F401
from schemas.wallet_bridge_api import response_schemas as wallet_bridge_api  # noqa: F401

__locals = locals().copy()
apis = {
    key: value
    for key, value in __locals.items()
    if key.endswith("_api") or key in ["jsonrpc"]
}
