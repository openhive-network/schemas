...
from schemas.__private.operation_objects import Hf26ApiAllOperationObject, Hf26ApiOperationObject, Hf26ApiVirtualOperationObject
...
GetCollateralizedConversionRequests = list[
    GetCollateralizedConversionRequestsFundament[AssetHiveHF26, AssetHbdHF26]
]
...
class GetDynamicGlobalProperties(
    database_api.GetDynamicGlobalProperties[AssetHiveHF26, AssetHbdHF26, AssetVestsHF26]
):
...
GetOpenOrders = HiveList[
    fundaments_database_api.LimitOrdersFundament[AssetHiveHF26, AssetHbdHF26]
]
...
class GetTransaction(
    account_history_api.GetTransactionModel[Hf26OperationRepresentationType]
):
    """Identical as in account_history_api"""
